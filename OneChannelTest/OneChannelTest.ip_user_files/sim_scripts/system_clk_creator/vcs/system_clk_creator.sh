...
#
# Script generated by Vivado on Fri Mar 15 16:12:51 CET 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_clk_creator.sh
...
#
# Usage        : system_clk_creator.sh
#                system_clk_creator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_clk_creator.sh [-reset_run]
#                system_clk_creator.sh [-reset_log]
#                system_clk_creator.sh [-help]
#
...
#                script (type 'system_clk_creator.sh -help' for more information).
#
...
# script info
echo -e "system_clk_creator.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_clk_creator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.system_clk_creator xil_defaultlib.glbl -o system_clk_creator_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./system_clk_creator_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dracho/Downloads/OneChannelTest/OneChannelTest/OneChannelTest.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key system_clk_creator_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc system_clk_creator_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_clk_creator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_clk_creator.sh [-help]\n\
Usage: system_clk_creator.sh [-step]\n\
Usage: system_clk_creator.sh [-lib_map_path]\n\
Usage: system_clk_creator.sh [-reset_run]\n\
Usage: system_clk_creator.sh [-reset_log]\n\
Usage: system_clk_creator.sh [-keep_index]\n\
Usage: system_clk_creator.sh [-noclean_files]\n\n\
