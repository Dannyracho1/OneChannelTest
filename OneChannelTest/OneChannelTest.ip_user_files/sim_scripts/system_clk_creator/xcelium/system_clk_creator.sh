...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.system_clk_creator xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.system_clk_creator -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dracho/Downloads/OneChannelTest/OneChannelTest/OneChannelTest.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log system_clk_creator_sc.so .tmp_log xcelium_lib waves.shm c.obj)
