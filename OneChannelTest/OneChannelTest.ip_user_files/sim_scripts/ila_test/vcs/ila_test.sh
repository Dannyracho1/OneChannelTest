...
#
# Script generated by Vivado on Thu Apr 18 14:29:00 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_test.sh
...
#
# Usage        : ila_test.sh
#                ila_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_test.sh [-reset_run]
#                ila_test.sh [-reset_log]
#                ila_test.sh [-help]
#
...
#                script (type 'ila_test.sh -help' for more information).
#
...
# script info
echo -e "ila_test.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../OneChannelTest.gen/sources_1/ip/ila_test/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../OneChannelTest.gen/sources_1/ip/ila_test/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_test xil_defaultlib.glbl -o ila_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_test_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_test.sh [-help]\n\
Usage: ila_test.sh [-step]\n\
Usage: ila_test.sh [-lib_map_path]\n\
Usage: ila_test.sh [-reset_run]\n\
Usage: ila_test.sh [-reset_log]\n\
Usage: ila_test.sh [-keep_index]\n\
Usage: ila_test.sh [-noclean_files]\n\n\
